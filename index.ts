...
import { Atraccion } from './scr/atraccion';
import { Parque } from './scr/parque';
import { MontanaRusa } from './scr/montanaRusa';
    ...
    switch (opcion) {
        case '1':
            ...
            if ( tipo === 1 ) {
             ...
             nuevaAtraccion = new MontanaRusa(nombre, precioBaseEntrada, capacidadMaximaDePersonas, alturaMinima);
        ...
        case '2':
            ...
            parque.atracciones.forEach((atraccion, i) => {
                ...
                Altura minima: ${'getAlturaMinima' in atraccion ? (atraccion as MontanaRusa).getAlturaMinima : ''}
